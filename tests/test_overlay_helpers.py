...
class TestKillTrackerOverlay(unittest.TestCase):
    ...
    def test_overlay_drag_prevention_when_locked(self, mock_label, mock_frame, mock_toplevel):
...
class TestOverlayThemes(unittest.TestCase):
    ...
    def test_theme_structure(self):
        ...
        required_keys = ["bg", "fg", "accent_kill", "accent_death", 
                        "accent_kd", "accent_streak", "border", "alpha"]
    ...
    def test_theme_alpha_range(self):
        ...
        for theme_name, theme in OVERLAY_THEMES.items():
            ...
            self.assertGreaterEqual(alpha, 0.0, 
                                  f"Theme {theme_name} alpha too low")
            self.assertLessEqual(alpha, 1.0, 
                               f"Theme {theme_name} alpha too high")
